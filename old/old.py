...
# --- CLIP Prompts ---
POSITIVE_PROMPTS = [
    "sexy", "seductive", "a high-resolution photograph", "realistic photo",
    "aesthetically pleasing", "masterpiece", "good quality image",
    "photorealistic", "clear image", "good composition",
]
NEGATIVE_PROMPTS = [
    "low quality", "unrealistic", "blurry image", "cartoon", "drawing",
