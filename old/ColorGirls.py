...
# --- CLIP Prompts ---
POSITIVE_PROMPTS = [
    "beauty", "sexy", "seductive", "beautiful", "naked", "lust", "orgasm",
    "dynamic lighting", "detailed skin", "clear image", "good composition",
]
NEGATIVE_PROMPTS = [
    "low quality", "cartoon", "drawing", "distorted", "blowjob", 
    "illustration", "deformed hand", "artifact", "extra fingers", "poorly drawn",  "flat lighting",
]
