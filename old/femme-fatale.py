...
# --- !!! NEW CONTROL FLAGS !!! ---
ENABLE_SCORE_PREFIX = False   # True = add "000_" to "100_" prefix, False = use original filenames
ENABLE_CATEGORY_SORTING = True # True = sort into worst/normal/best, False = copy all scored images to 'normal' folder
...
# --- CLIP Prompts ---
POSITIVE_PROMPTS = [
    "beauty", "sexy", "beautiful", "confident", "femme fatale", "gungirl", "armed",
    "dynamic lighting", "detailed skin", "good composition", "gun", "elegant"
]
NEGATIVE_PROMPTS = [
    "low quality", "distorted", "deformed", "three hands", "bad composition", "boring"
    "deformed hand", "artifact", "extra fingers", "poorly drawn", "flat lighting",
]
