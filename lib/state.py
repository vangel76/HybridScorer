...
def get_state_defaults(source_dir=None, prompt_backend=None):
    return {
        ...
        "os_cached_signature": None,
        "os_cached_feature_paths": None,
        "os_cached_patch_features": None,
        "os_cached_patch_image_idx": None,
        "os_cached_faiss_index": None,
        "os_cached_patch_gpu_tensor": None,
        "os_cached_failures": None,
